    ...
    if name == "tax_lawyer":
        ...
        return RetrievalStrategy(
            embedding_queries=[
                ...
                "Sociology doctoral candidate at prestigious university studying economic systems social inequality globalization, ethnographic research community-based methods, published working papers",
            ],
            tpuf_filters_strict=["And", [
                ["deg_degrees", "ContainsAny", ["Doctorate"]],
...
def llm_rerank_candidates(
    ...
    role_instructions = _get_role_specific_llm_instructions(query.name)
    system = (
        ...
        "IMPORTANT: Be strict about hard criteria but do not penalize candidates for missing data when context suggests they qualify.\n\n"
        f"{role_instructions}"
